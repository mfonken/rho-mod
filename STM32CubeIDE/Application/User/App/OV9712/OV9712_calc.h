...
#define COLOR_BAR_STYLE             COLOR_BAR_FADE
...
#else
#define PLL_PRE_DIVIDER             0x01 /* REG5C[6:5]: 1= /1, 2= /2, or 3= /4, default is 0x02 */
#define PLL_MULTIPLIER              0x1a /* REG5C[4:0]: 32- 0-31,               default is 0x19 */
